...
class SiameseBiLSTMAttention(nn.Module):
    def __init__(
        ...
        ## initialize self attention layers, config comes from self_attention_config
    ...
    def forward(self, sent1_batch, sent2_batch):
        ...
        sent_A, sent_A_attention = self.forward_once(sent1_batch)
        sent_B, sent_B_attention = self.forward_once(sent2_batch)
